...
describe('Safari Integration Tests', () => {
    ...
    test('should validate Safari manifest structure', () => {
      ...
      try {
        ...
        manifestContent = {
          ...
          version: '1.0.0',
          description:
            'Personal go-links system for quick navigation to your favorite URLs',
          permissions: [
            'storage',
            'tabs',
            'webNavigation',
          ...
          content_security_policy:
            "script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'; object-src 'self';",
        };
      }
  ...
  describe('Safari URL Navigation', () => {
    test('should handle go URL navigation in Safari', async () => {
      ...
      mockSafariAPI.webNavigation.onBeforeNavigate.addListener.mockImplementation(
    ...
    test('should redirect go URLs to target URLs', async () => {
      ...
      mockSafariAPI.tabs.update.mockImplementation(
        (tabId, updateProperties, callback) => {
  ...
  describe('Safari Tab Management', () => {
    ...
    test('should handle tab creation for new windows', async () => {
      mockSafariAPI.tabs.create.mockImplementation(
  ...
  describe('Safari Extension Context', () => {
    ...
    test('should handle Safari extension URL generation', () => {
      ...
      expect(resourceUrl).toBe(
        'safari-web-extension://test-extension-id/create.html'
      );
    });
  });
